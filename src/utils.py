...
""" 
Module utilitaire pour la visualisation des données et des résultats.
Séparé du code métier pour garder les scripts propres.
"""
...
def display_image(loader, number):
    """ Affiche une image moyenne du nombre souhaité """
...
def display_confusion_matrix(y_true, y_pred, title='Matrice de Confusion'):
